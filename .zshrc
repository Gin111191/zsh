...
# Shared clipboard (must come BEFORE plugins.zsh: zsh-vi-mode reads the ZVM_*
# variables as it loads, so setting them afterwards has no effect)
...
# =========================================================
# Conda (portable: only runs if anaconda3/miniconda3 exists)
# =========================================================

for _conda_root in "$HOME/anaconda3" "$HOME/miniconda3" "/opt/anaconda3" "/opt/miniconda3"; do
